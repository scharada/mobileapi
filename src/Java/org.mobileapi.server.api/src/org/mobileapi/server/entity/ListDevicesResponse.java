...
@XmlRootElement(name = "ListDevicesResponse")
public class ListDevicesResponse {

    protected List<ListDevicesResponse.Devices> devices;
     ...
     * {@link ListDevicesResponse.Devices }
     * 
     * 
     */
    public List<ListDevicesResponse.Devices> getDevices() {
        if (devices == null) {
            devices = new ArrayList<ListDevicesResponse.Devices>();
        }
        return this.devices;
    }
